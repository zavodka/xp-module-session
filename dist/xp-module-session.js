        ...
        return {
          show: function(type, params) {
            ...
            switch (type) {
              ...
              case 'registration':
                options = {
                  template: config.loginTemplate ? config.registerTemplate : 'templates/signUp.html',
              ...
              case 'password-restore':
                options = {
                  template: config.loginTemplate ? config.registerTemplate : 'templates/passwordRestore.html',
...
angular.module('xp-module-session').controller('PasswordRestoreCtrl', function($auth, $scope, moduleSession, $q, xpFormHelper, $rootScope, customParams) {
  ...
  $scope.emailSend = function() {
    var deferred, reset;
    if (!this.$scope[this._form].$valid) {
      return;
    }
